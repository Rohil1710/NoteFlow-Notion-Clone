...
locals {
  save_name   = "save-note-30129354"
  get_name    = "get-notes-30129354"
  delete_name = "delete-note-30129354"
...
resource "aws_lambda_function" "lambda" {
  ...
  environment {
      variables = {
        DYNAMODB_TABLE = "lotion-30139470"
...
# Dynamo table
resource "aws_dynamodb_table" "lotion-30139470" {
  name           = "lotion-30139470"
  hash_key       = "email"
  range_key      = "id"
